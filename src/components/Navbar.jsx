...
const Navbar = () => {
   ...
   return (
      <>
         <header
            className={`${
               isSticky && "bg-secondaryBg shadow-lg"
            } fixed top-0 right-0 left-0 z-10 transition duration-300`}
         >
            <nav>
               <div className="container flex justify-between items-center gap-8 py-6 px-6 md:px-6 lg:px-[7rem]">
                  <h1
                     className={`font-barlow font-extrabold italic text-slate text-2xl ${
                        isSticky ? "text-primary" : "text-whiteText"
                     }`}
                  >
